...
Al utilizar Degubar, usted, como usuario, nos confía su información. Mediante la presente política de privacidad (en adelante, la “Política”), informamos a nuestros usuarios cómo tratamos su información personal.


Si nuestra página web ( www.Degubar.com.ar ) o nuestra Aplicación “Degubar” para dispositivos móviles (en adelante, el “Portal”) contiene enlaces que conducen a la página web de otro proveedor, nuestra Política no se aplica a la página web a la que se le remite.


Esta Política aplica a todos los usuarios de nuestro Portal y es necesario prestar su consentimiento expreso, libre e informado al momento de registrarse como usuario de Degubar. Por tanto, con su consentimiento a la siguiente Política, usted autoriza a DEGUBAR S.A. y da su conformidad a la recopilación, procesamiento, uso y tratamiento de sus datos personales por nuestra parte, de conformidad con la normativa vigente en Argentina y en particular con la Ley 25.326 de Protección de Datos, así como cualquier norma que la reglamente, modifique o reemplace (en adelante, la “Normativa”).
...
Degubar y sus sociedades vinculadas o relacionadas (en adelante las "Sociedades Vinculadas") respeta y respetará sus derechos, aplicando y garantizando los siguientes principios orientadores de la Política:
...
Principio de Finalidad: El tratamiento de la información que no tenga el carácter de dato público, a los que tenga acceso y sean recopilados y recogidos por Degubar, estarán subordinados y atenderán una finalidad legítima, la cual será informada al respectivo usuario de dicha información.
Principio de Veracidad o Calidad: La información protegida sujeta a tratamiento debe ser veraz, completa, exacta, actualizada, comprobable y comprensible. Degubar no será responsable frente al Titular cuando sean objeto de tratamiento, datos o información parcial, incompleta o fraccionada o que induzca a error, entregada o divulgada por el Usuario declarando o garantizando, de cualquier forma, su veracidad o calidad.   Degubar podrá -en caso que fuera posible- pero no está obligado, a verificar la veracidad o calidad de la información aportada por el Usuario, no constituyendo esta facultad una eximición al Usuario de su obligación de aportar información veraz, completa, exacta y actualizada.    
Principio de Transparencia: En el tratamiento de información protegida, se garantizará el derecho del Usuario a obtener de Degubar, en cualquier momento y sin restricciones, información acerca de la existencia de cualquier tipo de información protegida que sea de su interés (legal, judicial o contractualmente justificado) y de su titularidad.
Principio de Acceso y Circulación Restringida: La información protegida no estará disponible en Internet u otros medios de divulgación o comunicación masiva, salvo que el acceso sea técnicamente controlable para brindar un conocimiento restringido sólo a Degubar, las Sociedades Vinculadas, los usuarios o terceros debidamente autorizados. Para estos propósitos la obligación de Degubar, será de medio, según lo establece la normativa vigente.  
Principio de Seguridad: La información protegida bajo la Política sujeta a tratamiento por Degubar, será objeto de protección en la medida en que los recursos técnicos y estándares mínimos así lo permitan, a través de la adopción de medidas tecnológicas de protección, protocolos, y medidas administrativas que sean necesarias para otorgar seguridad a los registros y repositorios electrónicos evitando su adulteración, modificación, pérdida, consulta, y en general en contra de cualquier uso o acceso no autorizado. En caso de que exista un riesgo particular de violación de la seguridad de la red, se informará a los usuarios sobre dicho riesgo y, si las medidas para atenuar o eliminar ese riesgo no están bajo su control, sobre las posibles soluciones.
Principio de Confidencialidad: Todas y cada una de las personas que en Degubar administran, manejan, actualizan o tienen acceso a información protegida que no tenga el carácter de pública, y se encuentre en sistemas de información o bases o bancos de datos de terceros debidamente autorizados, se comprometen a conservar y mantener de manera estrictamente confidencial y no revelar a terceros, todas o cualesquiera de las informaciones personales, comerciales, contables, técnicas, comerciales o de cualquier otro tipo suministradas en la ejecución y ejercicio de sus funciones. Degubar y sus Sociedades Vinculadas para el tratamiento de la información protegida podrán utilizar los sistemas de información y bases de datos de propiedad de Degubar y/o de sus Sociedades Vinculadas.
RESPONSABLE DEL TRATAMIENTO

Informamos a nuestros usuarios que el responsable de la base de datos es DEGUBAR S.A., CUIT 30-71198576-6, con domicilio en Mariscal Antonio José de Sucre 1530 Piso 6, Ciudad Autónoma de Buenos Aires, Argentina, y que los datos de carácter personal proporcionados a través del Portal, así como los que pudiera facilitar en el futuro en el marco de su relación con nosotros, son almacenados en nuestros servidores para ser conservados bajo seguridad de los mismos.
...
Si no sólo visita el Portal, sino que desea acceder a historial de pedidos (si ya fuera usuario) o si desea visualizar los servicios de Degubar, se le exige la registración como usuario para iniciar sesión. En tales supuestos se le solicita a aceptación expresa de esta Política y de los Términos y Condiciones generales de uso de DEGUBAR, recopilamos los siguientes datos personales:
...
Comentarios, puntuaciones y devoluciones, comunicaciones generales


Otros datos:

Datos o información que Ud. nos provea voluntariamente mientras utiliza el sitio web, aplicación u otras fuentes como redes sociales u otras bases de datos públicas.



Datos personales que recogemos al visitar nuestra página web, al registrarse y al realizar pedidos o utilizar los servicios de Degubar:

Los campos necesarios para la gestión de pedidos están marcados como obligatorios. Sin esta información no podemos procesar sus pedidos y brindar satisfactoriamente los servicios de Degubar. El resto de la información que no se muestra como campos obligatorios es opcional. Si usted nos proporciona voluntariamente esta información, nos ayudará a mejorar el servicio que le prestamos. Sin embargo, la omisión de esta información no le impedirá aprovechar todas prestaciones ofrecidas por Degubar. El alcance depende de la información que usted proporcione. Pero la información básica es la siguiente:
...
Esta información puede incluir el nombre completo, domicilio, fecha de nacimiento, número telefónico, email, información de pago (incluida información de verificación de pago vinculada), documento de identidad o número de documentos de identificación ante organismos públicos, número de socio en programas de promociones asociados a Degubar, foto de perfil.


Ubicación

Si el usuario da permiso para procesar sus datos de ubicación recopilamos dicha información precisa o aproximada a través de datos como GPS, dirección IP y wifi. Esta información se recopila cuando Degubar funciona en primer plano y/o cuando está en segundo plano si el usuario dio permiso a dichos efectos en su dispositivo móvil o en los ajustes de Degubar.
...
Comentarios, puntuaciones y devoluciones Y comunicaciones generales.


Historial de pedidos:

Información sobre el tipo de servicio que solicita, el tipo de pedido que realiza, el detalle del pedido, la información de entrega, la fecha y hora en la que se realiza el pedido, el precio y la forma de pago.  


Otra información:

Información que el usuario nos provea voluntariamente mientras utiliza el sitio web o la aplicación e información de otras fuentes tales como redes sociales o aplicaciones que utilicen nuestra interfaz de conexión u otras bases de datos públicas.



En cualquiera de los casos antes indicados, por favor tenga presente que toda información que usted nos provea según lo antes descripto, Degubar la considera información personal suya y que Ud. declara que la información brindada se corresponde con sus datos personales y que los mismos son correctos y actualizados.


Uso de los datos personales de los usuarios

Solo recolectamos sus datos personales cuando es necesario y la finalidad es lícita y previamente definida. Degubar recopila y usa su información personal para los propósitos especificados en esta Política o en las secciones relevantes de nuestro Portal.


Degubar utiliza su información para distintos fines:
...
Habilitarlo a usted para el uso de los servicios disponibles en el Portal.
Enviarle comunicados comerciales generales.
Realizar comentarios y valoraciones de los comercios adheridos, su oferta y productos.
...
Podemos utilizar la información que recopilamos para testear, investigar, analizar y desarrollar productos. Esto permite que podamos mejorar en términos de seguridad y que podamos desarrollar nuevas funciones o servicios.
...
Queremos evitar newsletters genéricas y medidas de marketing incontroladas. Por lo tanto, seleccionamos las ofertas que mejor se adapten a sus intereses y nos ponemos en contacto con usted si creemos que la información puede ser de su interés. Puede oponerse al tratamiento posterior de los datos con fines publicitarios con cada correo electrónico o en los ajustes en el Portal.


Degubar podrá utilizar la información para promocionar y procesar concursos y sorteos, entregas de premios y ofrecerle publicidad y contenidos relacionados con nuestros servicios y los de nuestros socios comerciales o comercios adheridos.


Asimismo, Degubar podrá enviarle muestras de productos.


Procedimientos judiciales o requerimientos administrativos

Podremos utilizar su información personal en caso que nos sea requerido por orden judicial o resolución administrativa, regulatoria, arbitral, y en general cuando sea requerido por cualquier autoridad gubernamental.


El Usuario presta su pleno y total consentimiento para que Degubar recopile sus datos personales y los utilice, transfiera, almacene y ceda, de conformidad con el uso de información previsto en esta Política de Privacidad.
...
En el evento que Degubar, en el ejercicio de sus actividades propias, utilice, transmita o transfiera internacionalmente datos personales garantizará el cumplimiento de los principios aplicables establecidos en la normativa aplicable.


Concretamente Degubar, en el giro ordinario de sus negocios podrá incorporar la información que Ud. nos provea dentro de sus sistemas de información. Degubar, como responsable del tratamiento garantiza que los sistemas de información cumplen en su integridad la Política y la Normativa vigente en materia de protección de datos personales en Argentina.

 

El usuario reconoce con la aceptación de la Política que, de presentarse una venta, fusión, consolidación, cambio de control societario, transferencia sustancial de activos, reorganización o liquidación de Degubar, Degubar podrá transferir, enajenar o asignar la Información Protegida a una o más partes relevantes, incluidas Sociedades Vinculadas.  

 

En la siguiente sección le indicamos a quién le informamos sus datos y bajo qué condiciones, así como a qué países los transferimos.


Qué terceros tienen acceso a los datos personales

Empresas vinculadas a Degubar

Podremos compartir datos con nuestras empresas vinculadas para facilitar y mejorar el procesamiento de nuestros datos sobre servicios. Por ejemplo, en la Unión Europea y Uruguay, Degubar procesa y almacena información en nombre de sus filiales internacionales.


Comercios adheridos a Degubar

Degubar comparte los datos estrictamente necesarios con los comercios adheridos a efectos de que los comercios adheridos puedan brindar el servicio contratado por parte de los usuarios.


Proveedores de servicios y comercios adheridos a Degubar

Degubar puede facilitar información a sus proveedores, consultores, socios de marketing, empresas de investigación y otros proveedores de servicios o socios comerciales. A modo de ejemplo Degubar podrá facilitar información a:
...
Proveedores de investigación, incluidos los que implementan estudios o proyectos de investigación en colaboración con Degubar o en su nombre.
Proveedores que ayudan a Degubar a mejorar la seguridad de sus apps.
Consultores y otros proveedores de servicios profesionales.

Otros

Degubar puede compartir su información de otra manera que no sea la descripta en esta Política si así se lo notificamos y lo acepta expresamente.
...
Para la rectificación, actualización, eliminación, así como a la oposición del tratamiento de los datos personales, el titular de los mismo podrá ejercer tales derechos dentro de los 5 (cinco) días hábiles de acreditada su identidad. Degubar procederá con dicha solicitud o informará de las razones por las que estime no corresponde en el plazo anteriormente indicado.
...
Toda información recabada en el Portal será tratada en cumplimiento de la Normativa y los datos personales serán utilizados únicamente para los fines aquí consentidos o los que consienta oportunamente. Degubar expresa su compromiso de proteger la seguridad de la información personal de los usuarios. Con ese fin, Degubar usa una amplia variedad de tecnologías y procedimientos de seguridad para proteger la información personal contra un acceso, uso, modificación o una divulgación no autorizados. Sin perjuicio de esto, le recomendamos que no incluya información confidencial, secreta, comprometedora, datos sensibles o información personal delicada que usted no desea revelar en estas comunicaciones (incluyendo correos electrónicos). Asimismo, usted es responsable de proteger la confidencialidad de saus credenciales de acceso a la aplicación.
